...
func Update(w http.ResponseWriter, r *http.Request) {
	if r.Method == "POST" {
		...
		if err != nil {
			log.Println("erro na conversão do id para inte", err)
		}
		...
		models.AtalizaProduto(idConvertidoParaInt, nome, descricao, precoConvertidaParaFloat, quantidadeConvertidaParaInt)
	}
	http.Redirect(w, r, "/", 301)
}
